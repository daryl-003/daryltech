...
var mcp_default = defineMcp({
  ...
  version: "0.1.0",
  instructions: "Tools for Daryl Tech Educational Network (DTEN): browse published blog posts, verify student certificates by enrollment ID (DTEN-...), and submit internship applications.",
